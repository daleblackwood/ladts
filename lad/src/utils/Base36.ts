function uintToBase36(n: number) {
    n = Number(n);
...
function uintFromBase36(s: string) {
    if (typeof s !== "string") {
...
function uintArrayToBase36(uints: number[], segmentLength: number) {
...
function uintArrayFromBase36(s: string, segmentLength: number) {
